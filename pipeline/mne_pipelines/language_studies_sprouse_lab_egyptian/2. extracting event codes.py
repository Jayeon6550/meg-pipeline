...
for i in range(n):  #loop through and append each name to the list
    ...
    file_name = 'sub-'+f'{i+1:03}'+'_task-egyptian_meg_analysis' #the data file
    word_count_name = 'word_count_'+'egyptian_list'+f'{i+1:02}' #the list
...
for folder_name,file_name,word_count_name in names:
    ...
    #----------------
    data_path = "/Users/jrs9906/Desktop/egyptian data/"+folder_name+"/meg/"
    ...
    # -----------------------------
    expected_matrix = compute_matrix_words(word_count_name+'.csv')
